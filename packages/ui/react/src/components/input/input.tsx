...
export function InputRoot(props: InputRootProps) {
	...
	return (
		<div className="relative flex items-center has-[input[data-disabled]]:opacity-50">
			...
			<InputHeadless
				className={cn(
					"h-10 flex-1 rounded-md border border-neutral-7 bg-neutral-1 px-2 text-start text-base text-neutral-12 outline-none ring-primary-7 transition sm:h-9 sm:text-sm",
