...
export const colors: Colors = {
	...
	primary: {
		1: { light: "#fdfdfe", dark: "#0c111c" },
		2: { light: "#f7f9ff", dark: "#111725" },
		3: { light: "#edf2fe", dark: "#172448" },
		4: { light: "#dfeaff", dark: "#1d2e61" },
		5: { light: "#d0dfff", dark: "#243974" },
		6: { light: "#bdd1ff", dark: "#2d4484" },
		7: { light: "#a6bff9", dark: "#375098" },
		8: { light: "#87a5ef", dark: "#405eb2" },
		9: { light: "#3d63dd", dark: "#3d63dd" },
		10: { light: "#3657c3", dark: "#3f5cb0" },
		11: { light: "#395bc7", dark: "#93b4ff" },
		12: { light: "#1d2e5c", dark: "#d5e2ff" },
	},
	secondary: {
		1: { light: "#fefdfc", dark: "#13110d" },
		2: { light: "#fff9f0", dark: "#1c1813" },
		3: { light: "#ffeed6", dark: "#2b2115" },
		4: { light: "#ffe3be", dark: "#382713" },
		5: { light: "#ffd8a6", dark: "#453016" },
		6: { light: "#f7cc9b", dark: "#543b1d" },
		7: { light: "#e9bb86", dark: "#684b26" },
		8: { light: "#daa360", dark: "#865f2e" },
		9: { light: "#d9a25f", dark: "#d9a25f" },
