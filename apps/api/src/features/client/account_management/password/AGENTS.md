# apps/api/src/features/client/account_management/password KNOWLEDGE BASE
...
| Task | Location | Notes |
|------|----------|-------|
| Routes | `routes.ts` | Guest `POST /client/account-management/password/forgot`, `POST /client/account-management/password/reset`; auth `PUT /client/account-management/password`. |
...
- Forgot/reset routes are guest-only under `/client/account-management/password`.
- Update password route is authenticated under `/client/account-management/password`.
