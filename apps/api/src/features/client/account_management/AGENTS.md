...
- Base paths use `/client/account-management`, with hyphens.
- Route names use `client.account_management`, with underscores.
...
- Route name prefix: `client.account_management.authentication`.
...
- Route name prefix: `client.account_management.password`.
...
- Route name prefix: `client.account_management.profile`.
- `GET /` targets `View`.
- `PUT /` targets `Update`.
