...
export function BeneficialOwnerCard(props: BeneficialOwnerCardProps) {
	const { form, index, onRemove, owner } = props;
	...
	return (
		...
		>
			...
			<BeneficialOwnerKindField form={form} index={index} ownerKind={owner.kind} />
			<BeneficialOwnerIdentityFields form={form} index={index} ownerKind={owner.kind} />
			...
			/>
			<BeneficialOwnerAddressFields form={form} index={index} />
		</section>
	);
}
