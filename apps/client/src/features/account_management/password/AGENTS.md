...
- Runtime password UI: `apps/client/src/features/account_management/password/`.
- Guest routes: `apps/client/src/routes/(guest)/{forgot-password,reset-password}`.
...
- Render in the authenticated account-management surface.
