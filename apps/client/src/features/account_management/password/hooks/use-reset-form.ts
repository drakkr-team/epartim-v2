...
import { useResetPasswordMutation } from "#/features/account_management/password/hooks/use-reset-mutation";
...
export function useResetPasswordForm(params: UseResetPasswordFormParams) {
	const { t } = useTranslation("features.account_management.password.hooks.use-reset-form");
