...
import { useForgotPasswordMutation } from "#/features/account_management/password/hooks/use-forgot-mutation";
...
export function useForgotPasswordForm(params?: UseForgotPasswordFormParams) {
	...
	const { t } = useTranslation("features.account_management.password.hooks.use-forgot-form");
