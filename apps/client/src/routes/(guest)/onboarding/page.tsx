...
import { ActivateForm } from "#/features/account_management/onboarding/components/activate-form.tsx";

const searchParamsSchema = z.object({
	token: z.string().optional(),
});

export const Route = createFileRoute("/(guest)/onboarding/")({
	validateSearch: searchParamsSchema,
	component: Page,
});

function Page() {
	const { t } = useTranslation("routes.(guest).onboarding");
