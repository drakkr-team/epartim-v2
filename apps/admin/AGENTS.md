...
- Keep the admin visually identical to the web app: use the shared theme tokens, fonts, theme mode, sidebar conventions, and shared UI components. Do not create admin-specific colors or typography.
